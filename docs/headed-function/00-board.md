...
| Assault | Fullest automated functional/E2E suite | Loop 01 |
| Fix | Root-cause S0/S1 | Loop 02 |
| Retest | Defect + prior PASS suite | Loop 02 evidence |
...
## Open S0/S1 after loop 02

None from this engagement. Remaining items are S2/S3 ACCEPT RISK listed on the board notes in loop 02.
